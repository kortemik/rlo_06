 ...
 */
package com.teragrep.new_rlo_06.fragment;
...
public class FragmentTest {
    ...
    public void testFragmentAssemblyViaByteFragmentClock() {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(inputBytes.length);
        byteBuffer.put(inputBytes);
        byteBuffer.flip();

        Fragment byteFragment = byteFragmentClock.submit(byteBuffer);
        Assertions.assertFalse(byteFragment.isStub());
        Assertions.assertEquals(1, byteFragment.size());

        // conversions
        Assertions.assertArrayEquals(new byte[] {
                53
        }, byteFragment.toBytes());
        Assertions.assertEquals("5", byteFragment.toString());
        Assertions.assertEquals(5, byteFragment.toInt());
